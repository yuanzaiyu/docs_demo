...
RestfulAPI supports only HTTPS. Authentication is performed based on RestfulAPI Key and respective RestfulAPI Secret(:ref:`API KeySecret`). Different from SDK's Vendor key/Sign Key, this API Key/Secret are used only for Restful API access.
